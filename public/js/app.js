...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/update-cart', pizza).then(function (res) {
    var _console;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1968563003_7_8_7_24_4", res)));
  })["catch"](function (error) {
    var _console2;
    /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1968563003_8_24_8_42_4", error)));
  });
}
