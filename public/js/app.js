...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/update-cart', pizza).then(function (res) {
    ...
    var _console;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("2975188481_23_24_23_42_4", error)));
  });
}
