...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/update-cart', pizza).then(function (res) {
    var _console;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1432578061_8_8_8_24_4", res)));
    cartCounter.innerText = res.data.totalQty;
  })["catch"](function (error) {
    var _console2;
    /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1432578061_10_24_10_42_4", error)));
  });
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_project"] = self["webpackChunkpizza_project"] || [];
